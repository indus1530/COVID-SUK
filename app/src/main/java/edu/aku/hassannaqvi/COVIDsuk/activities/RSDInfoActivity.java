package edu.aku.hassannaqvi.COVIDsuk.activities;
...
import edu.aku.hassannaqvi.COVIDsuk.RMOperations.crudOperations;
import edu.aku.hassannaqvi.COVIDsuk.core.MainApp;
import edu.aku.hassannaqvi.COVIDsuk.data.DAO.FormsDAO;
import edu.aku.hassannaqvi.COVIDsuk.data.DAO.GetFncDAO;
import edu.aku.hassannaqvi.COVIDsuk.data.entities.District;
import edu.aku.hassannaqvi.COVIDsuk.data.entities.FacilityProvider;
import edu.aku.hassannaqvi.COVIDsuk.data.entities.Forms;
import edu.aku.hassannaqvi.COVIDsuk.data.entities.Tehsil;
import edu.aku.hassannaqvi.COVIDsuk.databinding.ActivityRsdinfoBinding;
import edu.aku.hassannaqvi.COVIDsuk.get.db.GetAllDBData;
import edu.aku.hassannaqvi.COVIDsuk.get.db.GetIndDBData;
import edu.aku.hassannaqvi.COVIDsuk.utils.DateUtils;
import edu.aku.hassannaqvi.COVIDsuk.validation.ClearClass;
import edu.aku.hassannaqvi.COVIDsuk.validation.validatorClass;
